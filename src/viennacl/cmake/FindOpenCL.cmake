...
ELSE (APPLE)
	IF (WIN32)
	    ...
	    IF("${ISWIN64}" STREQUAL "Win64") 
	    	...
	    	FIND_LIBRARY(OPENCL_LIBRARIES libOpenCL.a "${OPENCL_LIB_DIR}" "$ENV{CUDA_LIB_PATH}" "$ENV{CUDA_PATH}/lib/x64")
	    ELSE("${ISWIN64}" STREQUAL "Win64") 
	    	#FIND_LIBRARY(OPENCL_LIBRARIES OpenCL.lib "${OPENCL_LIB_DIR}" "$ENV{CUDA_LIB_PATH}" "$ENV{CUDA_PATH}/lib/Win32")
	    	FIND_LIBRARY(OPENCL_LIBRARIES libOpenCL.a "${OPENCL_LIB_DIR}" "$ENV{CUDA_LIB_PATH}" "$ENV{CUDA_PATH}/lib/Win32")
