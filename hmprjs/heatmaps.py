...
#str_img_fn = ".\\imgs\\2007_002024.jpg"
#str_img_fn = ".\\imgs\\2007_000256.jpg"
#str_img_fn = ".\\imgs\\2011_003055.jpg"
str_img_fn = ".\\imgs\\2008_001042.jpg"
#str_img_fn = ".\\imgs\\2012_000960.jpg"
#str_img_fn = ".\\imgs\\2012_000276.jpg"
#str_img_fn = ".\\imgs\\2012_001443.jpg"
...
img_res = sktr.resize(img, (h_res, w_res) )
...
show_data("conv1 params", net_full_conv.params['conv1'][0].data.reshape(128*1,7,7))
...
plt.subplot(2, 2, 4),plt.title(labels[2])
plt.imshow(fulconv_data[0,2], plt.cm.cool)
#plt.imshow(fulconv_data[0,2], plt.cm.hot)
#plt.imshow(fulconv_data[0,2], plt.cm.gray)
plt.show()
